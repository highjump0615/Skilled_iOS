...
#import "ChooseCateViewController.h"
#import "CommonUtils.h"

@interface ChooseCateViewController () {
...
@implementation ChooseCateViewController
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (utils.mBlogToPost) {
        utils.mBlogToPost.category = [[BlogCategory alloc] initWithCategory:category];
    }
